...
C14.filter <- function(NEONET, 
  ...
  if(nrow(NEONET.noXY) > 0){
    out.file.noXY <- gsub(".xlsx", "_noXY.xlsx", neonet.bd.raw)
  ...
  # save 
  out.file <- gsub(".xlsx", "_inTime_inSpace.xlsx", neonet.bd.raw)
...
c14.BD.equ <- read.xlsx(paste0(c14.path.data.raw, "_equivalences_BD.xlsx"), 
                        skipEmptyRows = T)
